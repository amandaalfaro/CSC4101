...
{
    /// <summary>
    /// Indents console by '<paramref name="spacesToIndent"/>' amount of whitespaces.
    /// </summary>
    /// <param name="spacesToIndent">The number of spaces to indent.</param>
    public static void Indent(int spacesToIndent)
    {
